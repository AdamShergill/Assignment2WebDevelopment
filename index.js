...
app.get('/members', requireAuth, (req, res) => {
    ...
    const catName = catNames[catIds[0]];
    const catGifs = {
        '1': '/fluffy.gif',
        '2': '/socks.gif',
        '4': '/baby.gif'
    };
    const gifIds = Object.keys(catGifs);
    const catGif1 = catGifs[gifIds[0]]; 
    const catGif2 = catGifs[gifIds[1]]; 
    const catGif3 = catGifs[gifIds[2]]; 
